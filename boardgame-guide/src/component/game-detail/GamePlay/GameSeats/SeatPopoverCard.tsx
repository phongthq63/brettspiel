...
interface SeatPopoverCardProps extends GameSeat {
            ...
            <CardHeader>
                <div className="flex justify-between gap-8">
                    ...
                    <div className="min-w-8 flex items-center gap-2">
                        {!isMe && (
                            <Button
                                className="hover:bg-red-100 hover:text-black border-1 font-semibold"
                                variant="bordered"
                                color="danger"
                                radius="full"
                                size="sm"
                                onPress={handleSeatKick}
                            >
                                Kick
                            </Button>
                        )}
