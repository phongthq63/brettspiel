...
export default function GameInformation({image_box_url, minPlayers, maxPlayers, minPlayTime, maxPlayTime, designers, artists, publishers, year, gamesPlayed, complexity, strategy, luck, interaction,
}: GameInfoProps) {
    ...
    return (
        <div className="p-10">
            ...
            <div className="flex flex-col gap-4">
                <h2 className="text-xl font-bold">{t("information")}</h2>
                <div>
